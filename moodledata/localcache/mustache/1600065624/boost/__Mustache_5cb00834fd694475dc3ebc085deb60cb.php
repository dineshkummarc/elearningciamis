...
class __Mustache_5cb00834fd694475dc3ebc085deb60cb extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionAba760e94adbba85c65aba65978bd08d($context, $indent, $value);
    ...
    private function section0c6756198830abbbdcbac9c0531cc5a3(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionB228579e87d3803bbbf41afe683420ee(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionAba760e94adbba85c65aba65978bd08d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $buffer .= $indent . '        <ul class="m-t-1 pagination ">
';
                // 'previous' section
                $value = $context->find('previous');
                $buffer .= $this->section0c6756198830abbbdcbac9c0531cc5a3($context, $indent, $value);
                // 'first' section
                ...
                $buffer .= $this->sectionB228579e87d3803bbbf41afe683420ee($context, $indent, $value);
                $buffer .= $indent . '        </ul>
';
                $buffer .= $indent . '    </nav>
';
