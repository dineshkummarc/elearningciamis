...
class __Mustache_1fe09eb08fbe9466d686a4e8d38cf6c5 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'block2c38dd42da3507fa2d1399b01175a74b'),
            ));
...
';
    ...
    public function block2c38dd42da3507fa2d1399b01175a74b($context)
    {
        $indent = $buffer = '';
