...
class __Mustache_403d969248f4ee80380a7d4fecdb080e extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section5327c1fd30c45e4c35a1515a7d2b8659($context, $indent, $value);

        return $buffer;
    }

    private function section5327c1fd30c45e4c35a1515a7d2b8659(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
