...
class __Mustache_ac7c983b8f49e2b8d250d773588783c2 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section8e27baaa800f40a6969ec6c9edc81c4b($context, $indent, $value);
        $buffer .= $indent . '        </tbody>
';
        $buffer .= $indent . '    </table>
';
...
';
    ...
    private function section7517afe3ba6cf3483ac1592ac05ca1d1(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section02e93efa5de22a0de50dcb086cc37626(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                if ($parent = $this->mustache->loadPartial('core_calendar/minicalendar_day_link')) {
                    $context->pushBlockContext(array(
                        ...
                        'content' => array($this, 'block46ab9b3cbb22696191686ec6df95fe71'),
                    ));
    ...
    private function section5532a98e1305f74bcc33fa1553393bba(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->section02e93efa5de22a0de50dcb086cc37626($context, $indent, $value);
...
';
    ...
    private function section8e27baaa800f40a6969ec6c9edc81c4b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->section5532a98e1305f74bcc33fa1553393bba($context, $indent, $value);
                // 'postpadding' section
...
';
    ...
    public function block46ab9b3cbb22696191686ec6df95fe71($context)
    {
        $indent = $buffer = '';
        // 'events' section
        $value = $context->find('events');
        $buffer .= $this->section7517afe3ba6cf3483ac1592ac05ca1d1($context, $indent, $value);
