...
class __Mustache_a5bd6cce1a5529d85565b8f97f32692a extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionD1be1e0739f4bd5520ea235799afefdf($context, $indent, $value);
...
';
        ...
        $buffer .= $this->sectionC91eac4ffd26ebba421277547fd8aad7($context, $indent, $value);
    ...
    private function sectionD1be1e0739f4bd5520ea235799afefdf(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionC91eac4ffd26ebba421277547fd8aad7(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
