...
class __Mustache_abb54a1607b8d85d3d762c1dd1c51147 extends Mustache_Template
{
...
';
        $buffer .= $indent . '    <div class="mb-3 bg-white">
';
...
';
        $buffer .= $indent . '            <p class="hidden px-2" data-region="no-results-container">
';
        $buffer .= $indent . '                ';
        // 'str' section
        $value = $context->find('str');
        $buffer .= $this->section9fc5fbb399d2f3d621a8ff7f3b075194($context, $indent, $value);
        $buffer .= '
';
        $buffer .= $indent . '            </p>
';
...
';
        ...
        // 'str' section
        $value = $context->find('str');
        $buffer .= $this->section4875b5ef5fa0102ec5dcde66d723d79d($context, $indent, $value);
        $buffer .= '
';
        $buffer .= $indent . '            </p>
';
...
';
        ...
        // 'str' section
        $value = $context->find('str');
        $buffer .= $this->sectionA08cad2317ff2672e8f27de3ef04342e($context, $indent, $value);
        $buffer .= '
';
        $buffer .= $indent . '            </p>
';
...
';
    ...
    private function section9fc5fbb399d2f3d621a8ff7f3b075194(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = ' searchnocontactsfound, core_message ';
            $result = call_user_func($value, $source, $this->lambdaHelper);
            if (strpos($result, '{{') === false) {
                $buffer .= $result;
            } else {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= ' searchnocontactsfound, core_message ';
                $context->pop();
            }
        }
    ...
    private function section4875b5ef5fa0102ec5dcde66d723d79d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = ' searchnononcontactsfound, core_message ';
            $result = call_user_func($value, $source, $this->lambdaHelper);
            if (strpos($result, '{{') === false) {
                $buffer .= $result;
            } else {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= ' searchnononcontactsfound, core_message ';
                $context->pop();
            }
        }
    ...
    private function sectionA08cad2317ff2672e8f27de3ef04342e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = ' searchnomessagesfound, core_message ';
            $result = call_user_func($value, $source, $this->lambdaHelper);
            if (strpos($result, '{{') === false) {
                $buffer .= $result;
            } else {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= ' searchnomessagesfound, core_message ';
                $context->pop();
            }
        }
