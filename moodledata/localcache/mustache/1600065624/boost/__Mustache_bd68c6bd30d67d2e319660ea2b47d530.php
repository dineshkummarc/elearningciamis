...
class __Mustache_bd68c6bd30d67d2e319660ea2b47d530 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core/popover_region')) {
            $context->pushBlockContext(array(
                ...
                'togglecontent' => array($this, 'blockB3027e5ddba0f10489aed4ba03921a2d'),
                ...
                'headeractions' => array($this, 'block261b5f93d8e139955f98a4d020e793a2'),
...
';
    ...
    public function blockB3027e5ddba0f10489aed4ba03921a2d($context)
    {
        $indent = $buffer = '';
        $buffer .= '        ';
        // 'pix' section
