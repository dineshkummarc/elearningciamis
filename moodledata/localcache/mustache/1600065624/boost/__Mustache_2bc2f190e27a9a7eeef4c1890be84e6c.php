...
class __Mustache_2bc2f190e27a9a7eeef4c1890be84e6c extends Mustache_Template
{
...
';
        ...
        $buffer .= '</span>
';
        $buffer .= $indent . '            <span class="hidden ml-1" data-region="section-total-count-container">
';
...
';
        ...
        if ($parent = $this->mustache->loadPartial('core_message/message_drawer_lazy_load_list')) {
            $context->pushBlockContext(array(
                'rootclasses' => array($this, 'block691ba17c1b7dc81cab998d6a0dc439f9'),
                'rootattributes' => array($this, 'blockEbbe91f544dc994914bd8aa04f07fe35'),
            ));
...
';
    ...
    public function block691ba17c1b7dc81cab998d6a0dc439f9($context)
    {
        $indent = $buffer = '';
    ...
    public function blockEbbe91f544dc994914bd8aa04f07fe35($context)
    {
        $indent = $buffer = '';
        $buffer .= '            id="';
        $blockFunction = $context->findInBlock('region');
