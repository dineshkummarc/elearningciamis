...
class __Mustache_18bad7a48a7db0dfd49a5d202cb8c9a9 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'blockE751ad81d853cd4f8677de2488345814'),
            ));
...
';
    ...
    public function blockE751ad81d853cd4f8677de2488345814($context)
    {
        $indent = $buffer = '';
