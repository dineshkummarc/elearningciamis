...
class __Mustache_198b56062bd4e21f873292914c4cb61f extends Mustache_Template
{
...
';
        ...
        if ($parent = $this->mustache->loadPartial('core_message/message_drawer_view_contacts_body_section_contacts')) {
            $context->pushBlockContext(array(
                ...
                'rootattributes' => array($this, 'block21aeb3724864215278714ef06c3f7c09'),
            ));
...
';
        ...
        if ($parent = $this->mustache->loadPartial('core_message/message_drawer_view_contacts_body_section_requests')) {
            $context->pushBlockContext(array(
                ...
                'rootattributes' => array($this, 'blockD51c92cbf70ead5abf03db048c6d2f05'),
            ));
            $buffer .= $parent->renderInternal($context, $indent);
            $context->popBlockContext();
        }
...
';
    ...
    public function block21aeb3724864215278714ef06c3f7c09($context)
    {
        $indent = $buffer = '';
...
';
    ...
    public function blockD51c92cbf70ead5abf03db048c6d2f05($context)
    {
        $indent = $buffer = '';
