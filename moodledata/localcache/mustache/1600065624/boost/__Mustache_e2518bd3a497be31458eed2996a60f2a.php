...
class __Mustache_e2518bd3a497be31458eed2996a60f2a extends Mustache_Template
{
...
';
        $buffer .= $indent . '            <a class="h-100 d-flex align-items-center mr-2" href="#" data-route-back>
';
...
';
        $buffer .= $indent . '            <a href="#" data-route="view-search">
';
        $buffer .= $indent . '                ';
        // 'pix' section
