...
class __Mustache_2ae10b8d0c666522d08e0d74a3013b61 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'block6b5b0a3d2748d692885e041b35c6c152'),
            ));
...
';
    ...
    public function block6b5b0a3d2748d692885e041b35c6c152($context)
    {
        $indent = $buffer = '';
